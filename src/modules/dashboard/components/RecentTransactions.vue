...
<template>
  <Card class="rounded-2xl! border! border-slate-200! shadow-sm!">
    <template #title><div class="flex items-center justify-between gap-3"><h2 class="m-0 text-xl font-bold text-slate-800">Transaksi terbaru</h2><Button label="Lihat semua" text size="small" class="text-brand-700!" /></div></template>
    <template #content>
